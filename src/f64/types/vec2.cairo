...
fn test_add() {
    let a = Vec2Trait::new(
        FixedTrait::new(1, false), FixedTrait::new(2, false)
    );
    let b = Vec2Trait::new(
        FixedTrait::new(4, false), FixedTrait::new(5, false)
    );
    let c = a + b;
...
fn test_div() {
    let a = Vec2Trait::new(
        FixedTrait::new(4, false), FixedTrait::new(10, false)
    );
    let b = Vec2Trait::new(
        FixedTrait::new(1, false), FixedTrait::new(5, false)
    );
    let c = a / b;
