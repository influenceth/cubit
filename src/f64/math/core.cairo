...
fn test_exp() {
    ...
    assert_relative(exp(a), 31735754293, 'invalid exp of 2', Option::None(())); // 7.389056098793725
}
...
fn test_log2() {
    ...
    assert_relative(log2(a), 14267572527, 'invalid log2 10', Option::None(())); // 3.321928094887362
}
